 ...
 */
final class Version20210118102651 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE classe_eleve ADD CONSTRAINT FK_A5D651CF8F5EA509 FOREIGN KEY (classe_id) REFERENCES eleve (id_classe)');
